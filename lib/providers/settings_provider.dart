...
class ButtonSettingsProvider extends ChangeNotifier {
  ...
  static const List<bool> defaultButtonEnabled = [false, true, false, true, false, true, false, true, false];
  ...
  Future<void> loadSettings() async {
    ...
    for (int i = 0; i < numButtons; i++) {
      _buttonEnabled[i] = prefs.getBool('buttonEnabled_$i') ?? defaultButtonEnabled[i];
    }
    _isLoaded = true;
    notifyListeners();
  }
