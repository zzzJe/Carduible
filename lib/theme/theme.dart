...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff05677e),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff2e7e95),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff8cd5ef),
      onPrimaryContainer: Color(0xff000000),
      ...
      scrim: Color(0xff000000),
      inverseSurface: Color(0xffdee3e6),
      inversePrimary: Color(0xff002f3b),
      primaryFixed: Color(0xffc2eeff),
      onPrimaryFixed: Color(0xff000000),
      primaryFixedDim: Color(0xff8cd5ef),
